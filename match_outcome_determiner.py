...
from team_latest_match_stats import TeamLatestMatchStats
import random

class Match():
    def __init__(self, team1: Team, team2: Team):
        self.team1 = team1
        self.team1report = TeamLatestMatchStats(team1)
        self.team2 = team2
        self.team2report = TeamLatestMatchStats(team2)
        self.winner = None
        ...
        self.team1report.assign_match_cheaters()
        self.team2report.assign_match_cheaters()
        for i in range(len(all_players)):
            if all_players[i].cheated:
                all_players[i].make_cheater()

        # adjust team1's death numbers to match the team2's kill numbers
        team1_deaths_too_many = self.team1report.total_deaths() - self.team2report.total_kills()
        ...
        team2_deaths_too_many = self.team2report.total_deaths() - self.team1report.total_kills()
        ...
        team1KDA = self.team1report.total_kills() + self.team1report.total_assists() - self.team1report.total_deaths()
        team2KDA = self.team2report.total_kills() + self.team2report.total_assists() - self.team2report.total_deaths()
